...
const Services = () => {
  ...
  return (
    <Box sx={{mx:5}}>
       <NextSeo
        title={`Website Development Company in ${name}`}
        description={`Elegant Web Technologies is a website development company in ${name}`}
      />
      <CardMedia
        component='img'
        image='/website-development-services.jpg'
        sx={{
          height: "175px",
      ...
      >
        Website Development Services in {name}
      </Typography>
      <Box sx={{ display: "flex", flexDirection: "row", mt: 15, mx: 1 }}>
        ...
        <Box sx={{ mx: 4 }}>
          ...
          <Typography sx={{ textAlign: "justify" }}>
            Elegant Web Technologies is best website development company in {name}.
            ...
            committed to provide best website development services in the city. We
            have developed more than 1000 website till the date and number goes
            adding.
          </Typography>

          <Typography sx={{ textAlign: "justify" }}>
            Website development is most important thing for any company as nowadays
            online presence of any company is most important. We develop a
            website with a quality standards. We are reputed Website development
            company in {name}.
          </Typography>

          <Typography sx={{ textAlign: "justify" }}>
            Website development company should have trust, reliability and innovation
